        ...
        <div class="flex items-center space-x-1 flex-1 overflow-x-auto scrollbar-thin">
          {connectionStore.connections.map(conn => (
            <div
              key={conn.config.id}
              class={[
                'group flex items-center space-x-2 px-3 py-1.5 rounded-t-lg cursor-pointer transition-colors min-w-[120px] max-w-[200px]',
              ...
              onClick={() => connectionStore.setActiveConnection(conn.config.id)}
            >
              <div class={[
              ...
              <button
                ...
                onClick={(e) => handleCloseConnection(conn.config.id, e)}
              >
