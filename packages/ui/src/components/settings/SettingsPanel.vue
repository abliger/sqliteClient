        ...
        >
            ...
            >
                <div class="flex items-center space-x-2">
                    <Cog6ToothIcon class="w-5 h-5 text-surface-600 dark:text-surface-400" />
                    <h2 class="text-lg font-semibold text-surface-900 dark:text-surface-100">
                        {{ t('settings.title') }}
                    </h2>
                </div>
                <button
                    class="p-1.5 rounded hover:bg-surface-200 dark:hover:bg-surface-700 text-surface-500 dark:text-surface-400"
                    @click="closePanel"
                >
                        ...
                        <button
                            ...
                            :class="
                                currentLocale === option.value
                                    ...
                                    : 'border-surface-200 dark:border-surface-600 hover:border-surface-300 dark:hover:border-surface-500 hover:bg-surface-50 dark:hover:bg-surface-700'
                            "
            ...
            <!-- Footer -->
            <div
                class="px-4 py-3 border-t border-surface-200 dark:border-surface-700 bg-surface-50 dark:bg-surface-900"
            >
