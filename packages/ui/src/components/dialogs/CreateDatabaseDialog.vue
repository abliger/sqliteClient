        ...
        >
          ...
          >
            ...
            <div class="flex items-center justify-between px-5 py-4 border-b border-surface-200">
              ...
              <button
                class="p-1.5 rounded-lg hover:bg-surface-100 text-surface-500 transition-colors"
                @click="handleClose"
              >
            ...
            <div class="p-5 space-y-5">
              ...
              >
                ...
                <div class="p-3 bg-surface-100 rounded-lg">
                  <code class="text-xs text-surface-600 break-all">
                    {{ fullPath }}
                  </code>
                </div>
              </div>
            ...
            <!-- Footer -->
            <div class="flex items-center justify-end space-x-3 px-5 py-4 bg-surface-50 border-t border-surface-200">
              <button
                class="px-4 py-2 text-sm font-medium text-surface-700 hover:bg-surface-200 rounded-lg transition-colors"
                @click="handleClose"
              >
                {{ t('common.cancel') }}
              </button>
