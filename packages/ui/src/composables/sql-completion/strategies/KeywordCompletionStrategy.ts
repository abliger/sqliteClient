...
const DEFAULT_KEYWORDS = [
  ...
  'DISTINCT', 'CASE', 'WHEN', 'THEN', 'ELSE', 'END', 'IF', 'ALTER', 'ADD',
  'COLUMN', 'PRIMARY', 'KEY', 'FOREIGN', 'REFERENCES', 'UNIQUE', 'DEFAULT',
  'AUTOINCREMENT', 'CASCADE', 'RESTRICT', 'INT', 'INTEGER', 'REAL', 'TEXT',
  'BLOB', 'NUMERIC', 'BOOLEAN', 'DATE', 'DATETIME', 'VALUES', 'INTO', 'SET'
]
